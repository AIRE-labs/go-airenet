...
import (
	...
	"github.com/AIRE-labs/go-airenet/utils/iodb"
	"github.com/AIRE-labs/go-airenet/utils/ioread"
)
...
func importEvents(ctx *cli.Context) error {
	...
	cfg := makeAllConfigs(ctx)
	cfg.AIRE.Protocol.EventsSemaphoreLimit.Size = math.MaxUint32
	cfg.AIRE.Protocol.EventsSemaphoreLimit.Num = math.MaxUint32
	cfg.AIRE.Emitter.Validator = emitter.ValidatorConfig{}
	cfg.AIRE.TxPool.Journal = ""
	cfg.Node.IPCPath = ""
	cfg.Node.HTTPHost = ""
	cfg.Node.WSHost = ""
	cfg.Node.NoUSB = true
