Please check if what you want to add to `go-airenet` list meets [quality standards](https://github.com/AIRE-labs/go-airenet/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
